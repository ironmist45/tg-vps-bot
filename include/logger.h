...
/**
 * Tag field width: 5 characters, center-aligned with spaces.
 * Examples: [ CFG ] [ NET ] [STATE] [EXEC ]
 * Exception: [EXECCHK] — kept as-is (8 chars, no alignment)
 */
 ...
 * Note: tag width intentionally not aligned (8 chars).
 */
