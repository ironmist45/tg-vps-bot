 ...
 * tg_paths.h - Compile-time filesystem path constants
 *
 ...
 *
 * Named tg_paths.h (not paths.h) to avoid shadowing the system
 * header <paths.h> which defines _PATH_UTMP and other standard paths.
 *
